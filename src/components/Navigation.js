                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item">
                            <a href="#intro-section" className="nav-link"
                               onClick={(e) => scrollToSection(e, '#intro-section')}>
                                Home
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#itineraries" className="nav-link"
                               onClick={(e) => scrollToSection(e, '#itineraries')}>
                                Itinéraire
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#travel-info" className="nav-link"
                        ...
                        <li className="nav-item">
                            <a href="#gift-registries" className="nav-link"
                        ...
                        <li className="nav-item">
                            <a href="#rsvps" className="nav-link" onClick={(e) => scrollToSection(e, '#rsvps')}>
                                RSVP's
                            </a>
                        </li>
                    </ul>
